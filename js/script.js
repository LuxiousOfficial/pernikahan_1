...
ScrollReveal().reveal('.gallery .event h2, .gallery .photo h2, .bride .opening .paragraph, .bride .bride-judul h2, .reception .street h2, .location h2, .memory h2, .memory .video h2, .gift h2', { origin: 'top' });
...
ScrollReveal().reveal('.bride .opening .paragraph1, .bride .bride1, .bride-woman .bride-woman1, .reception .street .address, .reception .time .akad, .gift .bni, .gift .bca', { origin: 'left' });
ScrollReveal().reveal('.bride .opening .mean, .bride .container1, .bride-woman .container3, .reception .street p, .reception .time .akad1, .gift .bri', { origin: 'right' });
// Close ScrollReveal
